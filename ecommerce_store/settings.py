...
ALLOWED_HOSTS = ['.herokuapp.com','8000-fergal92-pp5ecommerce-ff0vcg2m6qt.ws.codeinstitute-ide.net']
...
DEFAULT_FROM_EMAIL = 'doggo@doggodownunder.com'

if 'DEVELOPMENT' in os.environ:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    DEFAULT_FROM_EMAIL = 'doggodownunder@gmail.com'
else:
